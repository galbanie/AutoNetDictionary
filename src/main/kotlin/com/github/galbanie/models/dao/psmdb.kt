...
import com.github.galbanie.models.dao.vcdb.*
import com.github.galbanie.models.dao.pcdb.*
import com.github.galbanie.models.dsl.vcdb.EngineValves
...
object HistoricSessions : IntIdTable("HISTORIC_SESSIONS","HISTORIC_SESSION_ID"){
...
class Entry(id: EntityID<Int>) : IntEntity(id) {
    ...
    var constraintOutput by ConstraintOutput referencedOn  Entries.constraintOutput_id
...
object ConstraintOutputs : IntIdTable("CONSTRAINT_OUTPUTS","CONSTRAINT_OUTPUT_ID"){
    val output_id = reference("OUTPUT",ParameterActions)
    val constraint_id = reference("CONSTRAINT",ParameterActions)
}
class ConstraintOutput(id: EntityID<Int>) : IntEntity(id) {
    companion object : IntEntityClass<ConstraintOutput>(ConstraintOutputs)
    var output by Parameter referencedOn ConstraintOutputs.output_id
    var constraint by Parameter referencedOn ConstraintOutputs.constraint_id
}
...
class ParameterAction(id: EntityID<Int>) : IntEntity(id) {
    ...
    var parameter by Parameter referencedOn  ConstraintOutputs.output_id
    var action by Action referencedOn ConstraintOutputs.constraint_id
}
